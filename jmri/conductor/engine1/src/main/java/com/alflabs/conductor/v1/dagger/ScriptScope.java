 ...
 * <pre>
 *     @ScriptScope @Subcomponent public interface ISomeScriptComponent { ... }
 *     @ScriptScope class SomePresenter { ... }
 *     class SomeScript { @Inject SomePresenter ... }
 * </pre>
 * The presenter injected in the script will be a singleton tied to the "script scope".
 * In Dagger it is implemented as a DoubleCheck member of the Component implementation and returned
 * to all users injected by the component.
 * <p/>
