...
import com.alflabs.conductor.v1.script.Event;
import com.alflabs.conductor.v1.script.IConditional;
import com.alflabs.conductor.v1.script.IIntFunction;
import com.alflabs.conductor.v1.script.IIntValue;
...
import com.alflabs.conductor.v1.script.ThrottleFactory;
import com.alflabs.conductor.v1.script.Timer;
import com.alflabs.conductor.v1.script.TimerFactory;
import com.alflabs.conductor.v1.script.Turnout;
import com.alflabs.conductor.v1.script.TurnoutFactory;
import com.alflabs.conductor.v1.script.Var;
import com.alflabs.conductor.v1.script.VarFactory;
    ...
    private class ConductorListenerImpl extends ConductorBaseListener {
        ...
        public void exitDefStrLine(ConductorParser.DefStrLineContext ctx) {
            ...
            if (ctx.defStrType().KW_STRING() != null) {
                ...
                if (ctx.defStrType().defImpExp() != null) {
                    var.setImported(ctx.defStrType().defImpExp().KW_IMPORT() != null);
                    var.setExported(ctx.defStrType().defImpExp().KW_EXPORT() != null);
                }
        ...
        public void exitDefIntLine(ConductorParser.DefIntLineContext ctx) {
            ...
            if (ctx.defIntType().KW_INT() != null) {
                Var var = mVarFactory.create(value, varName.toLowerCase(Locale.US));
                if (ctx.defIntType().defImpExp() != null) {
                    var.setImported(ctx.defIntType().defImpExp().KW_IMPORT() != null);
                    var.setExported(ctx.defIntType().defImpExp().KW_EXPORT() != null);
                }
                mScript.addVar(varName, var);
        ...
        public void exitDefEnumLine(ConductorParser.DefEnumLineContext ctx) {
            ...
            if (ctx.defImpExp() != null) {
                enum_.setImported(ctx.defImpExp().KW_IMPORT() != null);
                enum_.setExported(ctx.defImpExp().KW_EXPORT() != null);
            }
