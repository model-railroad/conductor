...
internal class Factory @Inject constructor(
    ...
    internal fun createVirtualBlock(
            systemName: String) : VirtualBlock =
        VirtualBlock(keyValue, condCache, eventLogger, systemName)

    internal fun createTurnout(
            systemName: String) : Turnout =
    ...
    internal fun createRoutesContainer(
        ...
        RoutesContainer(clock, logger, this, keyValue, eventLogger, simulCallback, builder)
