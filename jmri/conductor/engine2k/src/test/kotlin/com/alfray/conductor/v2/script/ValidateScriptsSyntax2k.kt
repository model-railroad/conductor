...
class ValidateScriptsSyntax2k : ScriptTest2kBase() {
    ...
    @Test
    fun testScript35() {
        loadScriptFromFile("script_v35.02_bl191+ml9538+1072+tl6885.conductor.kts")
        assertResultNoError()
    }

    @Test
    fun testScript36() {
        loadScriptFromFile("script_v36.01_bl191+ml9538+1072-tl6885.conductor.kts")
        assertResultNoError()
    }

    @Test
    fun testScript37() {
        loadScriptFromFile("script_v37.03_bl376+ml9538+1072-tl6885.conductor.kts")
        assertResultNoError()
    }

    @Test
    fun testScript38() {
        loadScriptFromFile("script_v38.01_bl376+ml9538+1072-tl6885.conductor.kts")
        assertResultNoError()
    }

    @Test
    fun testScript39() {
        loadScriptFromFile("script_v39.02_bl3450+ml9538+1072-tl6885.conductor.kts")
        assertResultNoError()
    }

    @Test
    fun testScript40() {
        loadScriptFromFile("script_v40.02_bl3450+ml9538+1072-tl6885.conductor.kts")
        assertResultNoError()
    }
}
